                ...
                if (checkBox1.Checked)
                {
                    ...
                    else
                    {
                        ...
                        using (SLDocument sl = new SLDocument(path))
                        {
                            ...
                            sl.SetCellValue("C4", comboBox2.Text);
                            ...
                            sl.SetCellValue(dataTable.Rows.Count + 14, 2, "Всего обработано вагонов - цистерн " + comboBox2.Text + " по видам операций:");
                            ...
                            sl.SaveAs(AppDomain.CurrentDomain.BaseDirectory + @"Report\" + comboBox2.Text + " Реестр  за арендованных и  собственных вагон-цистерн компании.xlsx");
                        }

                        dataTable.Clear();
                        Itog_Rep.Clear();
                        Process.Start(AppDomain.CurrentDomain.BaseDirectory + @"Report\" + comboBox2.Text + " Реестр  за арендованных и  собственных вагон-цистерн компании.xlsx");
                    }
                }
                else
                {
                    ...
                    {
                        if (checkBox2.Checked) //Общий реестр
                        {
                            if (comboBox2.SelectedIndex == 0)
                            {
                                //Refresh();
